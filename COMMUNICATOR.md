...
- **Files Modified**:
  - `config.py` — `MODEL_PRICING` table + `model_price()` (gemini-3.1-flash-lite $0.25/$1.50 per 1M in/out; gemini-embedding-2 $0.20/1M in, output free), env-overridable (`NORAI_MODEL_PRICE_*`).
